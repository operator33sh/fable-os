...
static const tool_t agenda_save_tool = {
    ...
    .input_schema =
        ...
        "object (HARD LIMIT: 288 bytes serialised - an inline app document "
        "will be truncated and the boot item will silently fail; save the "
        "document to /disk/apps/name.json first and pass "
        "{\\\"action\\\":\\\"launch\\\",\\\"file\\\":\\\"/disk/apps/name.json\\\"} "
        "here). With do=say: the sentence, as a string.\"},"
